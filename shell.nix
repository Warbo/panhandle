...
let
  ...
  f = { mkDerivation, aeson, base, binary, bytestring, Cabal
      , containers, data-default, derive, directory
      , extensible-exceptions, filepath, lazysmallcheck2012, mtl, network
      , old-locale, old-time, pandoc, pandoc-types, parsec, process
      , QuickCheck, random, stdenv, syb, tagged, tasty, tasty-quickcheck
      , text, time
      }:
      mkDerivation {
        pname = "panhandle";
